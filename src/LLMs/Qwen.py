...
def call_qwen(messages, model="qwen-long-0916", temperature=0.5, top_p=0,stop=None, response_format="text"):
...
"""
    ...
    response = call_qwen(messages,response_format="json_object")
    print(response) 